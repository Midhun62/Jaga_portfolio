...
export default function Home() {
  ...
  const dataText = ["JAGADEESHWARAN M", "JUNIOR ANALYST", "POLITICIAN"];
    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className="bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40 pt-20">
        <section id="home" className="min-h-screen py-8 sm:py-10 lg:py-12">
          ...
          >
            ...
            <ul className="hidden md:flex items-center space-x-4">
              ...
              <li>
                <a className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8" href="Jagadeeshwaran CV.pdf" download>Resume</a>
              </li>
            </ul>
          ...
          <div className="text-center p-10 py-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              "Hello! I'm JAGADEESHWARAN M, a Computer Science graduate and aspiring Data Analyst passionate about building practical, real-world tech solutions. Explore my portfolio to see my skills and journey in technology."
            </p>
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">

              <a href="https://www.linkedin.com/in/jagadeeshwaran-m-930670295?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="hover:text-[#0077B5] dark:hover:text-[#0077B5] transition-colors shadow-lg">
                <AiFillLinkedin />
              </a>
              <a href="https://youtube.com/@jjlifestimetamil?si=Ou1mvPRTEWVE0hna" target="_blank" rel="noopener noreferrer" className="hover:text-[#FF0000] dark:hover:text-[#FF0000] transition-colors shadow-lg">
                <AiFillYoutube />
              </a>
            </div>
          </div>
        ...
        <section id="about" className="py-8">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="text-md leading-8 text-gray-800 dark:text-gray-200">I am a Computer Science graduate with a strong interest in Data Analytics and software development. I enjoy working with data to extract meaningful insights and support data-driven decision-making. I have hands-on experience in Python, MySQL, Excel, and data visualization tools, along with a solid foundation in programming concepts. I am a quick learner who continuously upgrades my skills and enjoys collaborating in team environments to solve real-world problems.
              {/* techniology cards */}
              <div className="mt-12 mb-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 mb-12">
                  ...
                  <div className="relative bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-transform duration-300">
                    <div className="p-6 hover:bg-gradient-to-r from-cyan-300 to-teal-300">
                      <div className="flex items-center justify-center h-16 w-16 rounded-full mb-4 mx-auto">
                        <img src="looker.png" alt="JavaScript Icon" className="h-16 w-16" />
                      </div>
                      <h3 className="text-center text-xl font-semibold mb-2 dark:text-black">Looker Studio</h3>
                    </div>
                  </div>
                  ...
                  <div className="relative bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-transform duration-300">
                    <div className="p-6 hover:bg-gradient-to-r from-cyan-300 to-teal-300">
                      <div className="flex items-center justify-center h-16 w-16 rounded-full mb-4 mx-auto">
                        <img src="/excel.png" alt="Excel" className="h-16 w-16" />
                      </div>
                      <h3 className="text-center text-xl font-semibold mb-2 dark:text-black">EXCEL</h3>
                    </div>
                  </div>
                ...
                <div className="max-w-7xl mx-auto w-full grid grid-cols-9">
                  ...
                  <div className="col-span-4 w-full h-full">
                    <div className="w-full h-full bg-teal-500 rounded-md p-2 md-pl-4">
                      <h1 className="text-xl font-medium pt-2">SKV Matric Higher Secondary School, Kandampalayam</h1>
                      <p className="font-light pb-2">2017 - 2018</p>
                      <p className="sm:text-sm text-xs">I have completed my SSLC</p>
                    </div>
                  </div>
                  ...
                  <div className="col-span-4 w-full h-full">
                    <div className="w-full h-full bg-gray-500 rounded-md p-2 md-pl-4">
                      <h1 className="text-xl font-medium pt-2">Little Angels Higher Secondary School, Aniyapuram</h1>
                      <p className="font-light pb-2">2019 - 2020</p>
                      <p className="sm:text-sm text-xs">I have completed my HSC</p>
                    </div>
                  </div>
                  {/* Timeline Item 3 */}
                  <div className="col-span-4 w-full h-full">
                    <div className="w-full h-full bg-teal-500 rounded-md p-2 md-pl-4">
                      ...
                      <p className="sm:text-sm text-xs">I have completed my B.E. Computer Science and Engineering degree</p>
                    </div>
                  </div>
                  ...
                  <div className="relative col-span-1 w-full h-full flex justify-center items-center">
                    <div className="h-full w-1 bg-teal-500"></div>
                    <div className="absolute w-6 h-6 rounded-full bg-teal-500 z-10 text-black text-center">4</div>
                  </div>

                  <div className="col-span-4 w-full h-full">
                    <div className="w-full h-full bg-gray-500 rounded-md p-2 md:pl-4">
                      <h1 className="text-xl font-medium pt-2">Data Science Course</h1>
                      <p className="sm:text-sm text-xs">Completed my data science course in ExcelR Institute in Bangalore.</p>
                    </div>
                  </div>
                  ...
                  <div className="relative col-span-1 w-full h-full flex justify-center items-center">
                    <div className="h-full w-1 bg-teal-500"></div>
                    <div className="absolute w-6 h-6 rounded-full bg-teal-500 z-10 text-black text-center">5</div>
                  </div>
                  <div className="col-span-1 w-full h-full"></div>
                  ...
                  <div className="col-span-4 w-full h-full">
                    <div className="w-full h-full bg-gray-500 rounded-md p-2 md-pl-4">
                      <h1 className="text-xl font-medium py-2">Business and Politician</h1>
                      <p className="sm:text-sm text-xs">Currently doing various Business and also Entered in political</p>
                    </div>
                  </div>
      ...
      <footer className="w-full bg-gray-800 text-gray-200 py-6">
        <div className="container mx-auto text-center">
          <p className="text-md">
            © 2024 JAGADEESHWARAN M. All rights reserved.
          </p>
          ...
          <div className="flex justify-center gap-4 mt-4">
            ...
            <a href="https://www.linkedin.com/in/jagadeeshwaran-m-930670295" target="_blank" rel="noopener noreferrer" className="hover:text-teal-500">
              <AiFillLinkedin className="text-2xl" />
            </a>
            <a href="https://youtube.com/@jjlifestimetamil?si=Ou1mvPRTEWVE0hna" target="_blank" rel="noopener noreferrer" className="hover:text-teal-500">
